defmodule DoitWeb.TodoLiveTest do
  use DoitWeb.ConnCase

  import Phoenix.LiveViewTest
  import Doit.TodosFixtures

  @create_attrs %{description: "some description", done: true, title: "some title"}
  @update_attrs %{description: "some updated description", done: false, title: "some updated title"}
  @invalid_attrs %{description: nil, done: false, title: nil}
